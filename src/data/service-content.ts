...
export const serviceContent: Record<string, ServiceContent> = {
  'landscape-design': {
    ...
    ctaText: "Schedule a free on-site consultation. We'll walk your property, discuss your vision, and develop a plan that fits your budget.",
  },
  ...
  'landscape-maintenance': {
    ...
    detailCards: [
      ...
      },
      {
        ...
        text: "For properties with irrigation systems, we provide spring activation, mid-season adjustments, and fall winterization. We also monitor for leaks, broken heads, and coverage gaps. Proper irrigation management saves water and keeps your landscape healthy through Rochester's variable summers.",
    ...
    detailCards: [
      {
        ...
        text: "Create the ultimate outdoor entertaining space. We build patios from natural stone, pavers, and concrete in configurations that complement your home's architecture. Add a built-in grill, countertop, or bar for a fully functional outdoor kitchen.",
      ...
      },
      {
        ...
        text: "Upgrade your curb appeal and functionality with a paver or natural stone driveway. We also build commercial parking areas, turnarounds, and aprons that handle heavy traffic while looking sharp. All installations include proper base work for Rochester's freeze-thaw conditions.",
  ...
  'water-features': {
    ...
    detailCards: [
      ...
      },
      {
        ...
        text: 'Water features in Rochester need seasonal care. We provide spring startup services, routine maintenance through the season, and fall winterization to protect your investment from freeze damage. Our maintenance programs include pump inspection, filter cleaning, water treatment, and debris removal to keep your feature running beautifully.',
  ...
  'snow-ice-management': {
    ...
    detailCards: [
      ...
      },
      {
        ...
        text: "Slip-and-fall liability is a serious concern for any commercial property. Our sidewalk crews clear walkways, building entrances, emergency exits, and ADA-accessible paths with snow blowers, shovels, and brooms. We don't leave until surfaces are safe for foot traffic.",
      ...
      },
      {
        ...
        text: "Lock in your winter budget with a seasonal contract that covers the entire snow season. No per-push surprises, no worrying about whether a storm triggers service. Our seasonal agreements are tailored to your property's needs and give you predictable costs from November through April.",
  ...
  'holiday-lighting': {
    ...
    processSteps: [
      ...
      { title: 'INSTALLATION', text: 'Our experienced crew installs lights and decorations with care — no damage to your property.' },
    ...
    ctaText: "Book your holiday decorating early — reservations fill up fast. Let us handle the lights while you enjoy the holidays.",
  },
};
